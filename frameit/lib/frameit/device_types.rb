...
module Frameit
  ...
  module Devices
    ...
    IPHONE_15_PLUS ||= Device.new("iphone-15-plus", "Apple iPhone 15 Plus", 13, [[1290, 2796], [2796, 1290]], 460, Color::BLACK, Platform::IOS)
    IPHONE_15_PRO ||= Device.new("iphone-15-pro", "Apple iPhone 15 Pro", 13, [[1179, 2556], [2556, 1179]], 460, Color::BLACK, Platform::IOS)
    IPHONE_15_PRO_MAX ||= Device.new("iphone-15-pro-max", "Apple iPhone 15 Pro Max", 13, [[1290, 2796], [2796, 1290]], 460, Color::BLACK, Platform::IOS)
    IPHONE_16 ||= Device.new("iphone-16", "Apple iPhone 16", 14, [[1179, 2556], [2556, 1179]], 460, Color::BLACK, Platform::IOS)
    IPHONE_16_PLUS ||= Device.new("iphone-16-plus", "Apple iPhone 16 Plus", 14, [[1290, 2796], [2796, 1290]], 460, Color::BLACK, Platform::IOS)
    IPHONE_16_PRO ||= Device.new("iphone-16-pro", "Apple iPhone 16 Pro", 14, [[1206, 2622], [2622, 1206]], 460, Color::BLACK, Platform::IOS)
    IPHONE_16_PRO_MAX ||= Device.new("iphone-16-pro-max", "Apple iPhone 16 Pro Max", 14, [[1320, 2868], [2868, 1320]], 460, Color::BLACK, Platform::IOS)
    IPHONE_16E ||= Device.new("iphone-16e", "Apple iPhone 16e", 14, [[1179, 2556], [2556, 1179]], 460, Color::BLACK, Platform::IOS)
    IPHONE_17_AIR ||= Device.new("iphone-17-air", "Apple iPhone 17 Air", 15, [[1206, 2622], [2622, 1206]], 460, Color::BLACK, Platform::IOS)
    IPHONE_17_PRO ||= Device.new("iphone-17-pro", "Apple iPhone 17 Pro", 15, [[1206, 2622], [2622, 1206]], 460, Color::BLACK, Platform::IOS)
    IPHONE_17_PRO_MAX ||= Device.new("iphone-17-pro-max", "Apple iPhone 17 Pro Max", 15, [[1320, 2868], [2868, 1320]], 458, Color::DEEP_BLUE, Platform::IOS)
    IPAD_10_2 ||= Device.new("ipad-10-2", "Apple iPad 10.2", 1, [[1620, 2160], [2160, 1620]], 264, Color::SPACE_GRAY, Platform::IOS)
    IPAD_10_9 ||= Device.new("ipad-10-9", "Apple iPad (10th generation)", 2, [[1640, 2360], [2360, 1640]], 264, Color::SILVER, Platform::IOS)
    ...
    IPAD_AIR_11_M2 ||= Device.new("ipad-air-11-m2", "Apple iPad Air 11-inch (M2)", 4, [[1640, 2360], [2360, 1640]], 264, Color::SPACE_GRAY, Platform::IOS)
    IPAD_AIR_13_M2 ||= Device.new("ipad-air-13-m2", "Apple iPad Air 13-inch (M2)", 4, [[2048, 2732], [2732, 2048]], 264, Color::SPACE_GRAY, Platform::IOS)
    IPAD_AIR_11_M3 ||= Device.new("ipad-air-11-m3", "Apple iPad Air 11-inch (M3)", 5, [[1640, 2360], [2360, 1640]], 264, Color::SPACE_GRAY, Platform::IOS)
    IPAD_AIR_13_M3 ||= Device.new("ipad-air-13-m3", "Apple iPad Air 13-inch (M3)", 5, [[2048, 2732], [2732, 2048]], 264, Color::SPACE_GRAY, Platform::IOS)
    ...
    IPAD_MINI_6 ||= Device.new("ipad-mini-6", "Apple iPad mini (6th generation)", 4, [[1488, 2266], [2266, 1488]], 326, Color::SPACE_GRAY, Platform::IOS)
    IPAD_MINI_7 ||= Device.new("ipad-mini-7", "Apple iPad mini (A17 Pro)", 5, [[1488, 2266], [2266, 1488]], 326, Color::SPACE_GRAY, Platform::IOS)
    ...
    IPAD_PRO_11_M4 ||= Device.new("ipad-pro-11-m4", "Apple iPad Pro 11-inch (M4)", 6, [[1668, 2420], [2420, 1668]], 264, Color::SPACE_GRAY, Platform::IOS)
